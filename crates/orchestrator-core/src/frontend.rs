...
use crate::{BackendNeedsInputAnswer, CoreError, ProjectionState, WorkItemId, WorkerSessionId};
...
pub enum FrontendTerminalEvent {
    Output {
        ...
        output: crate::BackendOutputEvent,
    },
    TurnState {
        session_id: WorkerSessionId,
        turn_state: crate::BackendTurnStateEvent,
    },
    NeedsInput {
        session_id: WorkerSessionId,
        needs_input: crate::BackendNeedsInputEvent,
    },
    StreamFailed {
        session_id: WorkerSessionId,
        message: String,
...
impl FrontendCommandIntent {
    ...
    pub const fn command_id(self) -> &'static str {
        match self {
            ...
            Self::OpenTerminalForSelected => crate::command_ids::UI_OPEN_TERMINAL_FOR_SELECTED,
            Self::OpenDiffInspectorForSelected => {
                crate::command_ids::UI_OPEN_DIFF_INSPECTOR_FOR_SELECTED
            }
            Self::OpenTestInspectorForSelected => {
                crate::command_ids::UI_OPEN_TEST_INSPECTOR_FOR_SELECTED
            }
            Self::OpenPrInspectorForSelected => {
                crate::command_ids::UI_OPEN_PR_INSPECTOR_FOR_SELECTED
            }
            Self::OpenChatInspectorForSelected => {
                crate::command_ids::UI_OPEN_CHAT_INSPECTOR_FOR_SELECTED
            }
            Self::StartTerminalEscapeChord => "ui.mode.terminal_escape_prefix",
            Self::QuitShell => "ui.shell.quit",
            Self::FocusNextInbox => crate::command_ids::UI_FOCUS_NEXT_INBOX,
